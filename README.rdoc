...
<tt>$ STRIPE_PUBLISHABLE_KEY='<em>live pk</em>' STRIPE_SECRET_KEY='<em>live sk</em>' SECRET_KEY_BASE='<em>secret</em>' subsmulti_DATABASE_PASSWORD='<em>password</em>' RAILS_ENV=production bundle exec rackup -E production</tt>
